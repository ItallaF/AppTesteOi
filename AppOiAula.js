...
import { View, Text, StyleSheet, TouchableOpacity, Image, Button, Alert, ScrollView } from 'react-native';
    ...
    return (      
      <View style={styles.container}> 
       ...
       <Text style={styles.img}>
        <Image source={{uri:'https://www.pngkey.com/png/full/380-3801757_oi-novos-logos-da-oi.png'}}
        style={{width: 150,
        height: 100}}/></Text>
